...
3. Check out [these basic practice exercises](https://github.com/Momentum-Team-9/examples/tree/main) for a warm-up. Clone that repo to work on the exercises locally. You do _not_ need to turn this in.
